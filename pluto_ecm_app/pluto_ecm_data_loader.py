...
class pluto_ecm_data_loader:
  def __init__(self, logger, filename, speed=10.0):
    ...
    self.logger.log(self.logger.LL_INFO, "[pluto_ecm_data_loader] opened {} -- first_time={} offset={}".format(filename, first_time, self.time_offset))
  ...
  def get_entries_up_to_time(self, t):
    ...
    while not self.input_done:
      ...
      if len(line) == 0:
        self.logger.log(self.logger.LL_INFO, "[pluto_ecm_data_loader] finished reading file -- lines_processed={}".format(self.lines_processed))
