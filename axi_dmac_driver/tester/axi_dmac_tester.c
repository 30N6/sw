...
void print_buffer(const char *pref, const struct iio_buffer *dma_buffer)
{
...
int main (int argc, char **argv)
{
  ...
  IIO_ENSURE((ctx = iio_create_context_from_uri("ip:192.168.2.1")) && "No context");
