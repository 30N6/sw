...
ESM_REPORT_LENGTH_STATUS                = 512
ESM_REPORT_LENGTH_DWELL_STATS           = 512
ESM_REPORT_LENGTH_PDW_SUMMARY           = 512
ESM_REPORT_LENGTH_PDW_PULSE_EMPTY       = 56

ESM_NUM_CHANNELS_FULL                   = 1
...
ESM_PDW_BUFFERED_SAMPLES_PER_FRAME      = 112
...
NUM_DWELL_STATS_TRAILER_BYTES = ESM_REPORT_LENGTH_DWELL_STATS - PACKED_DWELL_STATS_HEADER.size
